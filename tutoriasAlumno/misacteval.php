...
$query_actividades_evaluadas = "SELECT la.idactividad, nombreActividad, ruta, fecha_entrega, estatus, estado, calificacion, accion 
  from listaActividades as la
  join actividades as ac on ac.idactividad=la.idactividad 
